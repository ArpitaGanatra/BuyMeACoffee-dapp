...
import { CONTRACT_ADDRESS, CONTRACT_ABI } from "../utils/BuyMeACoffee";
        ...
        <div className={styles.content}>
            ...
            {currentAccount &&
              memos.map((memo, idx) => {
                ...
                return (
                  <div key={idx}>
                    <p>
                      {memo.name} {memo.timestamp.toString()}
                    </p>
                    <p>{memo.message}</p>
                  </div>
                );
          ...
          <div className={styles.right}>
            <form>
              ...
              <br />
              <div>
                <label> Send Arpita a message</label>
                <textarea
                  type="text"
                  id="message"
                  rows="3"
...
// import {CONTRACT_ABI} from '../utils/BuyMeACoffee'
// import { ethers } from "ethers";
// import Head from 'next/head'
// import Image from 'next/image'
